...
| الملف | الوصف |
|-------|-------|
| `01_schema.sql` | هيكل جميع الجداول (17 جدول) |
| `02_seed_data.sql` | البيانات الأساسية (مستخدم admin، أنواع البضائع، المحافظات، المنافذ) |
| `03_indexes.sql` | فهارس إضافية لتحسين الأداء |
| `04_sample_data.sql` | بيانات تجريبية للاختبار (اختياري) |
