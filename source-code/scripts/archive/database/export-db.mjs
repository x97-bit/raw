...
async function exportDatabase() {
  const connection = await mysql.createConnection(buildMySqlConnectionOptions(DATABASE_URL));
  ...
  // Write to file
  const outputPath = path.resolve(process.cwd(), 'database', 'exports', 'alrawi-database-export.json');
