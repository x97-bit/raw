...
const TEMPLATE_DEFS = [
  {
    ...
    widths: [
      16, 14, 18, 14, 12, 26, 24, 22, 24, 14, 14, 12, 14, 16, 16, 16, 16, 18,
      20, 16, 18, 24, 22, 24, 24,
    ],
  },
  {
    key: "port_1",
    ...
    widths: [
      14, 18, 14, 12, 24, 24, 22, 24, 14, 14, 16, 16, 16, 16, 18, 20, 18, 16,
      22, 24,
    ],
  },
  {
  ...
  },
  {
    ...
    widths: [
      14, 18, 14, 12, 24, 24, 22, 24, 14, 12, 16, 16, 16, 16, 22, 22, 24,
    ],
  },
  {
    key: "transport_1",
  ...
  },
  {
    ...
    required: ["المحافظة"],
    columns: ["المحافظة", "أجر النقل (دينار)", "ملاحظات"],
    widths: [22, 18, 26],
  },
];
...
function main() {
  ...
  XLSX.utils.book_append_sheet(
    workbook,
    makeSheet(README_ROWS, [26, 32, 34]),
    "README"
  );
