...
export const SPECIAL_ACCOUNT_DEFS = {
  haider: {
    ...
    surfaceGradient: 'linear-gradient(155deg, rgba(14,19,25,0.98) 0%, rgba(22,29,38,0.96) 58%, rgba(41,58,76,0.92) 100%)',
  ...
  'partnership-yaser': {
    ...
    surfaceGradient: 'linear-gradient(155deg, rgba(14,19,25,0.98) 0%, rgba(22,29,38,0.96) 58%, rgba(37,56,51,0.92) 100%)',
