...
export const PORT_SECTION_SUMMARY_META = {
  ...
  'port-1': {
    list: [
      ...
      { key: 'balanceUSD', label: 'مبلغ المفلتر دولار', format: 'usd', accent: PORT_SUMMARY_TONES.filteredUsd },
      { key: 'balanceIQD', label: 'مبلغ المفلتر دينار', format: 'iqd', accent: PORT_SUMMARY_TONES.filteredIqd },
      { key: 'totalWeight', label: 'مجموع الوزن الكلي', format: 'number', accent: PORT_SUMMARY_TONES.weight },
    ],
    statement: [
      { key: 'totalInvoicesUSD', label: 'الطلب الكلي دولار', format: 'usd', accent: PORT_SUMMARY_TONES.usd },
      { key: 'totalInvoicesIQD', label: 'الطلب الكلي دينار', format: 'iqd', accent: PORT_SUMMARY_TONES.iqd },
  ...
  'partnership-1': {
    list: [
      { key: 'totalInvoicesUSD', label: 'إجمالي الدولار', format: 'usd', accent: PORT_SUMMARY_TONES.usd },
      { key: 'totalInvoicesIQD', label: 'إجمالي الدينار', format: 'iqd', accent: PORT_SUMMARY_TONES.iqd },
    ],
    statement: [
      { key: 'balanceUSD', label: 'إجمالي الدولار', format: 'usd', accent: PORT_SUMMARY_TONES.filteredUsd },
      { key: 'balanceIQD', label: 'إجمالي الدينار', format: 'iqd', accent: PORT_SUMMARY_TONES.filteredIqd },
    ],
  },
};
