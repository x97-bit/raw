...
const renderMoneyValue = value =>
  value ? formatTrialBalanceNumber(value) : "-";
...
export const TRIAL_BALANCE_ALL_COLUMNS = [
  ...
  },
  {
    ...
    isCenter: true,
    colorClass: `${ACCENT_TONE} font-semibold`,
  },
  {
    key: "opening_usd",
    dataKey: "opening_usd",
    label: "رصيد افتتاحي ($)",
    format: "money",
    render: renderMoneyValue,
    colorFn: getBalanceTone,
  },
  {
    key: "opening_iqd",
    dataKey: "opening_iqd",
  ...
  },
  {
    ...
    label: "الرصيد ($)",
    format: "money",
    render: value => formatTrialBalanceNumber(value || 0),
    isBold: true,
    colorFn: getBalanceTone,
  },
  {
