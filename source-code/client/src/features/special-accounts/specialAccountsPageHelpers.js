...
export function applyLoadedSpecialFieldConfigs(
  current,
  haiderConfig,
  partnerConfig
) {
  return {
    ...current,
    "special-haider": resolveFieldConfigEntry(
      haiderConfig,
      current["special-haider"]
    ),
    "special-partner": resolveFieldConfigEntry(
      partnerConfig,
      current["special-partner"]
    ),
  };
}
