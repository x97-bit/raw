        ...
        <div className="surface-card space-y-4">
          <div>
            ...
            <AutocompleteInput
              ...
              onSelect={(account) => onFieldChange('AccountName', account.AccountName)}
          ...
          <div className="flex gap-3 border-t border-white/[0.06] pt-4">
            <button onClick={onSave} disabled={saving} className="btn-primary flex flex-1 items-center gap-2">
