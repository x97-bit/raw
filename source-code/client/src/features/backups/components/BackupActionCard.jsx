export default function BackupActionCard({
  ...
  return (
    ...
    >
      <div className={`flex h-11 w-11 items-center justify-center rounded-[18px] ${accentBgClass} ${accentTextClass}`}>
        <Icon size={18} />
      </div>
      <div>
        <div className="text-base font-black text-white">{title}</div>
        <div className="mt-1 text-sm leading-6 text-[#91a0ad]">{description}</div>
      </div>
    </Component>
  );
}
