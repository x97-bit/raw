    ...
    <section className="surface-card space-y-4 p-5">
      <div className="text-right">
        ...
        <p className="mt-1 text-sm text-[#91a0ad]">
          متابعة النسخة اليومية على الخادم مع أمر الجدولة المقترح وملفات SQL
          المكتشفة.
        </p>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-[22px] bg-white/[0.04] p-4">
          ...
          <div className="mt-2 text-sm font-bold text-white">
            {status?.dailyBackup?.latestBackup
      ...
      <div className="space-y-2">
        <div className="text-sm font-semibold text-[#cbd5df]">
          أمر الجدولة المقترح
        </div>
        <div
          className="rounded-[22px] bg-[#0f141b] px-4 py-3 text-sm text-[#dbe7f0]"
          dir="ltr"
        >
      ...
      <div className="space-y-2 text-sm text-[#b7c3ce]">
        <div dir="ltr">
          Script: {status?.dailyBackup?.scriptPath || "غير متوفر"}
        </div>
        <div dir="ltr">
          SQL dir: {status?.directories?.dailySql || "غير متوفر"}
        </div>
      </div>
    </section>
  );
