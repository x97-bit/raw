...
const IDLE_TAB_CLASS = 'bg-white/6 text-[#91a0ad] hover:bg-white/10 hover:text-[#eef3f7]';
...
export default function DefaultsManagementToolbar({
  ...
  return (
    <section className="surface-card grid gap-4 p-5 lg:grid-cols-[220px_1fr_auto]">
      <div>
        <label className="mb-1.5 block text-[13px] font-semibold text-[#91a0ad]">القسم</label>
        <select
      ...
      <div>
        <label className="mb-1.5 block text-[13px] font-semibold text-[#91a0ad]">بحث داخل السجلات</label>
        <div className="relative">
          <Search size={15} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#91a0ad]" />
          <input
            value={search}
