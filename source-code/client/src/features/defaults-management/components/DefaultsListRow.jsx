...
export default function DefaultsListRow({
  active,
  title,
  badges,
  onSelect,
  ...
  return (
    <div
      className={`flex items-start justify-between gap-3 px-5 py-4 transition-colors ${active ? "bg-primary-50/60" : "hover:bg-slate-50"}`}
    >
