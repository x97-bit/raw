      ...
      >
        ...
        >
          <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
            ...
            <button onClick={onClose} className="rounded-lg p-1.5 transition-all hover:bg-gray-100">
              <X size={17} className="text-gray-400" />
            </button>
          </div>
          <div className="p-6">
            {subtitle && <p className="mb-4 text-sm font-medium text-gray-400">{subtitle}</p>}
            {children}
          </div>
        </div>
      </div>
