  ...
  return (
    ...
    >
      <div className="space-y-4">
        <div className="rounded-[20px] border border-warning/20 bg-warning/10 px-4 py-3 text-sm leading-7 text-warning">
          <div className="mb-1 flex items-center gap-2 font-bold text-warning">
            <ShieldAlert size={16} />
            <span>معلومة أمنية</span>
          </div>
          <p className="text-warning/90">
            لا يمكن إظهار كلمة المرور الحالية لأي مستخدم. البديل الصحيح هو تعيين
            كلمة جديدة ثم مشاركتها مع المستخدم.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <div className="absolute inset-y-0 left-2 flex items-center gap-1">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-xl bg-secondary/20 text-muted-foreground transition-colors hover:bg-secondary/40 hover:text-foreground"
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-xl bg-secondary/20 text-muted-foreground transition-colors hover:bg-secondary/40 hover:text-foreground disabled:cursor-not-allowed disabled:opacity-40"
          ...
          <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-xs">
            <span className="text-muted-foreground">
              يمكنك كتابة كلمة المرور يدويًا أو توليد كلمة مؤقتة قوية.
            </span>
            <span
              className={`font-semibold ${copied ? "text-success" : "text-muted-foreground"}`}
            >
