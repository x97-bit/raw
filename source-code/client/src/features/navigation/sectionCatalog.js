...
export const sectionConfig = {
  ...
  partnership: { title: 'الشراكة', portId: 'partnership-1', accountType: 5, type: 'partnership', accent: '#4f7d74', actions: ['invoice', 'payment', 'statement', 'traders'] },
  fx: { title: 'الصيرفة', portId: 'fx-1', accountType: 3, type: 'fx', accent: '#6679a6', actions: ['invoice', 'traders', 'statement'] },
};
...
const mainSectionGroups = [
  ...
  },
  {
    ...
    accent: '#7c6f63',
    items: [
      { id: 'transport', perm: 'transport', label: 'النقل', icon: Truck, accent: '#7c6f63', bg: 'rgba(124,111,99,0.16)' },
      { id: 'partnership', perm: 'partnership', label: 'الشراكة', icon: Handshake, accent: '#4f7d74', bg: 'rgba(79,125,116,0.16)' },
    ],
  },
  {
    title: 'الحسابات',
    ...
    accent: '#7b8796',
    items: [
      { id: 'debts', perm: 'debts', label: 'الديون', icon: CreditCard, accent: '#8a6e79', bg: 'rgba(138,110,121,0.16)' },
      { id: 'expenses', perm: 'debts', label: 'المصاريف', icon: Receipt, accent: '#8b735d', bg: 'rgba(139,115,93,0.16)' },
      { id: 'special', perm: 'special', label: 'حسابات خاصة', icon: Wallet, accent: '#4f7d74', bg: 'rgba(79,125,116,0.16)' },
      { id: 'fx', perm: 'fx', label: 'الصيرفة', icon: Landmark, accent: '#6679a6', bg: 'rgba(102,121,166,0.16)' },
      { id: 'payment-matching', perm: 'reports', label: 'ربط التسديد', icon: Link2, accent: '#6f7a96', bg: 'rgba(111,122,150,0.16)' },
    ],
  },
  {
    ...
    accent: '#7087a6',
    items: [
      { id: 'reports', perm: 'reports', label: 'التقارير', icon: BarChart3, accent: '#7087a6', bg: 'rgba(112,135,166,0.16)' },
      { id: 'trial-balance', perm: 'reports', label: 'ميزان المراجعة', icon: Scale, accent: '#648ea9', bg: 'rgba(100,142,169,0.16)' },
    ],
  },
];
