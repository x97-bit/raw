...
export const INVOICE_OR_PAYMENT_NOT_FOUND_MESSAGE = "الفاتورة أو سند القبض المطلوب غير موجود";
export const FIRST_RECORD_MUST_BE_INVOICE_MESSAGE = "السجل الأول يجب أن يكون فاتورة";
export const SECOND_RECORD_MUST_BE_PAYMENT_MESSAGE = "السجل الثاني يجب أن يكون سند قبض";
export const ACCOUNT_MISMATCH_MESSAGE = "لا يمكن مطابقة فاتورة وسند قبض لحسابين مختلفين";
export const DUPLICATE_MATCH_MESSAGE = "هذه المطابقة موجودة مسبقًا";
export const USD_OVERMATCH_MESSAGE = "مبلغ الدولار المطلوب أكبر من الرصيد المتبقي للمطابقة";
export const IQD_OVERMATCH_MESSAGE = "مبلغ الدينار المطلوب أكبر من الرصيد المتبقي للمطابقة";
