...
export function buildSpecialAccountMutationData(
  ...
  const resolvedType =
    normalizeText(
      pickBodyField(body, "type", "Type") ?? fallbackType,
      fallbackType || ""
    ) || "";
  ...
  assign("traderName", ["traderName", "TraderName"], value =>
    normalizeText(value)
  );
  ...
  assign("portName", ["portName", "PortName", "port", "Port"], value =>
    normalizeText(value)
  );
  assign("companyName", ["companyName", "CompanyName"], value =>
    normalizeText(value)
  );
  assign("batchName", ["batchName", "BatchName"], value =>
    normalizeText(value)
  );
  assign("destination", ["destination", "Destination"], value =>
    normalizeText(value)
  );
  assign(
    "amountUSD",
  ...
  assign("date", ["date", "Date", "TransDate"], value =>
  ...
  if (
    !partial ||
    hasAnyBodyKey(body, ["description", "Description", "notes", "Notes"])
  ) {
    data.description = normalizeText(
      pickBodyField(body, "description", "Description", "notes", "Notes"),
      ""
    );
  }
