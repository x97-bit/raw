...
export async function getCustomFieldsWithSections(db: any, sectionKey?: string) {
...
export async function syncCustomFieldSections(db: any, fieldKey: string, sections: string[]) {
