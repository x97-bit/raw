...
describe("Per-port field mapping", () => {
  const KSA_FIELDS = ['ref_no', 'trans_date', 'account_name', 'currency', 'driver_name', 'vehicle_plate', 'good_type', 'weight', 'meters', 'cost_usd', 'amount_usd', 'cost_iqd', 'amount_iqd', 'fee_usd', 'gov_name', 'notes'];
